...
namespace NetworkCheckers.Jogo.Engine
{
    ...
    public class CheckersRules : IBoardRules
    {
        ...
        private const int BLACK_BEGIN_POSITON = 1;
        private const int BLACK_END_POSITION = 12;
        private const int WHITE_BEGIN_POSITON = 21;
        private const int WHITE_END_POSITION = 32;
